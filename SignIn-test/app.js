...
//for hidden environment variables
...
//We also need to serve the CSS styling to format the outlook of the HTML form.
...
app.use(session({
    secret: uuidv4(), //so it uses the uuid of the user and its competely secret. To seee if it works, we can use the 'secret' // '1b0d6bcd-bbfd-4b2d-9b2d-ab8dfbbd4bed'
    resave: false,
